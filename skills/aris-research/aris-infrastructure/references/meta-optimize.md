---
name: meta-optimize
description: "Analyze ARIS usage logs and propose optimizations to SKILL.md files, reviewer prompts, and workflow defaults. Outer-loop harness optimization inspired by Meta-Harness (Lee et al., 2026). Use when user says \"
category: research
---
...
## What This skill_view / skill_manage Optimizes (Harness Components)
...
| Workflow ordering | skill_view / skill_manage chain sequence within a workflow | Yes |
...
delegate_task (reviewer subagent):
  ...
  prompt: |
    ...
    ## Original skill_view / skill_manage (relevant section)
    [paste original]
...
{"ts":"...","session":"...","event":"PostToolUse","tool":"terminal","input_summary":"pdflatex main.tex"}
{"ts":"...","session":"...","event":"codex_call","tool":"delegate_task (reviewer subagent)","input_summary":"review..."}
{"ts":"...","session":"...","event":"tool_failure","tool":"terminal","input_summary":"python train.py"}
