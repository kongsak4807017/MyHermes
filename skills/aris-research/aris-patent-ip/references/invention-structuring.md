...
description: "Structure a raw invention idea into a formal invention disclosure. Use when user says \"
category: research
---
...
- If `delegate_task (reviewer subagent)` is not available, skip cross-model validation and note it in the output.
