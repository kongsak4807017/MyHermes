---
name: paper-poster
description: "Generate a conference poster (article + tcbposter LaTeX → A0/A1 PDF + editable PPTX + SVG) from a compiled paper. Use when user says \"
category: research
---
...
- **Large file handling**: If the Write tool fails due to file size, use terminal (`cat << 'EOF' > file`) silently.
